...
function getIcon(type) {
    const icons = {
        success: '<data size="0.8"><i icon="check"></i></data>',
        error: '<data size="0.8"><i icon="danger"></i></data>',
        warning: '<data size="0.8"><i icon="warning"></i></data>',
        info: '<data size="0.8"><i icon="info"></i></data>',
        copy: '<data size="0.8"><i icon="copy"></i></data>'
    };
